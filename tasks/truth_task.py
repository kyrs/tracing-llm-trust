...
from utils.performance_functions.truth_dataset import truthfulness_contrastive_loss

BATCH_TYPE = Dict[str, torch.Tensor]

class TruthTask(Task):
    ...
    def compute_measurement(
        ...
        return truthfulness_contrastive_loss(model, batch)
